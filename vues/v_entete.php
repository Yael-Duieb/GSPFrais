              ...
              <div class="row vertical-align">
                  ...
                  <div class="col-md-8">
                      <ul class="nav nav-pills-c pull-right" role="tablist">
                          <li <?php if (!$uc || $uc == 'accueil') { ?>class="active" <?php } ?>>
                              <a  onmouseover="this.style.background='#ffffff';this.style.color='#ff6f02';" href="index.php">
                                  <span class="glyphicon glyphicon-home"></span>
                                  Accueil
                              </a>
                          </li>
                          <li <?php if ($uc == 'gererFrais') { ?>class="active"<?php } ?>>
                              <a  onmouseover="this.style.background='#ffffff';this.style.color='#ff6f02';" href="index.php?uc=validerFrais&action=choixVM">
                                  <span class="glyphicon glyphicon-pencil"></span>
                          ...
                          <li
                          <?php if ($uc == 'deconnexion') { ?>class="active"<?php } ?>>
                              <a  onmouseover="this.style.text='#ffffff';" style="color: orange" href="index.php?uc=deconnexion&action=demandeDeconnexion">
                                  <span class="glyphicon glyphicon-log-out"></span>
                                  Déconnexion
                              </a>
                          </li>
